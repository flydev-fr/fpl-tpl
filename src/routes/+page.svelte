...
<section class="hero">
	...
	<div class="bottom layout-grid">
		...
		<Button
			...
			arrow={true}
			icon={GitHub}
			href="https://github.com/sekretservices"
		>
...
<section class="theme-light featuring" bind:this={whiteRectRef}>
	<div class="inner">
		<div class="layout-block intro">
			<p class="p-l">
				VPL is an{' '}
				<Link class="contrast semi-bold" href="https://github.com/sekretservices">
					open-source library
				</Link>{' '}
